    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-y-auto transition-colors"
        ...
        >
          ...
          <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 mt-1 transition-colors">
                {isLogin ? "Sign in to your account" : "Join the Lumoire community"}
              </p>
            </div>
            <Button
              variant="ghost"
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              >
                <div className="flex items-start space-x-2">
                  ...
                  <Label htmlFor="agreeToTerms" className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                    I agree to the{" "}
                    <a href="#" className="text-teal hover:text-teal/80 underline">
                      Terms of Service
                    </a>{" "}
                    and{" "}
                    <a href="#" className="text-teal hover:text-teal/80 underline">
                ...
                <div className="flex items-start space-x-2">
                  ...
                  >
                    Subscribe to our newsletter for updates and creator spotlights
                  </Label>
                </div>
              </motion.div>
            )}
            ...
            <Button
              ...
              className="w-full bg-teal hover:bg-teal/90 text-white py-3 text-base font-medium disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
                <motion.div
                  animate={{ rotate: 360 }}
          ...
          {/* Footer */}
          <div className="px-6 py-4 bg-gray-50 dark:bg-gray-700/50 border-t border-gray-200 dark:border-gray-700 rounded-b-2xl transition-colors">
